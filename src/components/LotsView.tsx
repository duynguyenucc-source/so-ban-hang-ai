    ...
    <div className="flex-1 overflow-y-auto p-4 space-y-4">
      ...
      <div className="bg-emerald-800 text-white p-3.5 rounded-lg flex flex-col md:flex-row items-center justify-between gap-3 shadow-sm">
        ...
        <button
          ...
          className="w-full md:w-auto bg-yellow-400 hover:bg-yellow-500 text-emerald-950 text-xs font-black px-4 py-2 rounded flex items-center justify-center gap-1.5 transition-all shadow-sm"
        >
          {isAuditLoading ? (
        ...
        <div className="col-span-12 lg:col-span-5">
          <div className="bg-white rounded-lg shadow-sm border p-3.5 space-y-3">
            ...
            <form onSubmit={handleProcessSubmit} className="space-y-3">
              ...
              <button
                type="submit"
                disabled={!selectedLotId || inputWeight <= 0}
                className="w-full bg-emerald-800 hover:bg-emerald-950 text-white font-black py-2 rounded-lg text-xs uppercase shadow-sm flex items-center justify-center gap-1.5 disabled:opacity-40 transition-all"
              >
                <Check size={14} />
